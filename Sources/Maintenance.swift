...
final class Maintenance {
    ...
    private let queue = DispatchQueue(label: "dev.yuezheng2006.fuchen.maintenance", qos: .utility)
    ...
    private func tick() {
        ...
        do {
            ...
            NSLog("Fuchen.Maintenance: prune failed: \(error.localizedDescription)")
        ...
        if Store.autoVacuum, self.lastPruneDeleted > 1_000 {
            do {
                ...
                NSLog("Fuchen.Maintenance: vacuum failed: \(error.localizedDescription)")
            }
        }
